...
<head>
    ...
    body {
            ...
            min-height: 100vh; /* Ensure the parent container takes full viewport height */
            background-image: url('https://rejolut.com/wp-content/uploads/2022/02/voting7.png'); /* Path to your background image */
    ...
    <div class="card">
        ...
        <form id="voteForm">
            ...
            <select id="vote" name="vote" required>
                <option value="Candidate 1 : Nitish">Candidate 1 : Nitish</option>
                <option value="Candidate 2 : Ayush">Candidate 2 : Ayush</option>
            </select>
...
votingApp.post("/vote", async (req, res) => {
    ...
    try {
        ...
        if (vote === "Candidate 1 : Nitish" || vote === "Candidate 2 : Ayush") {
        ...
        res.send(`
          ...
          <head>
              ...
              body {
                  ...
                  align-items: center;
                  min-height: 100vh;
                  background-image: url('https://rejolut.com/wp-content/uploads/2022/02/voting7.png');
          ...
          <body>
              <div class="card">
                  ...
                  <p><strong>Candidate 1 : Nitish:</strong> ${votes[0]}</p>
                  <p><strong>Candidate 2 : Ayush:</strong> ${votes[1]}</p>
                  <form action="/" method="GET">
